...
TOOL_ACTION EE_ACTIONS::analyseLCEDASYM( "eeschema.SymbolLibraryControl.analyseLCEDASYM", AS_GLOBAL,
                                         0, "", _( "analyseLCEDASYM..." ),
                                         _( "Import a symbol to the current library" ),
                                         BITMAPS::import_part );
TOOL_ACTION EE_ACTIONS::multianalyseLCEDASYM( "eeschema.SymbolLibraryControl.multianalyseLCEDASYM",
                                              AS_GLOBAL,
                                         0, "", _( "multianalyseLCEDASYM..." ),
                                         _( "Import multi symbols to the current library" ),
                                         BITMAPS::import_part );
...
TOOL_ACTION EE_ACTIONS::placeImportedGraphics( TOOL_ACTION_ARGS()
        .Name( "eeschema.InteractiveDrawing.placeImportedGraphics" )
        .Scope( AS_GLOBAL )
...
//TOOL_ACTION EE_ACTIONS::placeImportedGraphics( "eeschema.InteractiveDrawing.placeImportedGraphics",
//                                                AS_GLOBAL, 0, "",
//                                                _( "Import Graphics..." ),
//                                                _( "Import 2D drawing file" ),
//                                                BITMAPS::image, AF_ACTIVATE );

//TOOL_ACTION EE_ACTIONS::importFPAssignments(
//        "eeschema.EditorControl.importFPAssignments", AS_GLOBAL, 0, "",
