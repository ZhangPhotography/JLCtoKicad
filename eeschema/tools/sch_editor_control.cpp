...
int SCH_EDITOR_CONTROL::Addsymbol( const TOOL_EVENT& aEvent )
{
    wxString lastOpenFile = "";
    //m_frame->OpenFileDialog( lastOpenFile );
    return 0;
}
...
void SCH_EDITOR_CONTROL::setTransitions()
{
    ...
    Go( &SCH_EDITOR_CONTROL::Addsymbol,                ACTIONS::addsymbol.MakeEvent() );
