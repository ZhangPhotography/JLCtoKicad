...
// import SVG/DXF graphics(-sxl)
int SCH_DRAWING_TOOLS::PlaceImportedGraphics( const TOOL_EVENT& aEvent )
{
    std::string strInFileFullPath = "";
    wxString    lastOpenFile = "";
    wxFileName  fn =  m_frame->OpenFileDialog( lastOpenFile,1 );
...
void SCH_DRAWING_TOOLS::setTransitions()
{
    ...
    Go( &SCH_DRAWING_TOOLS::PlaceImportedGraphics, EE_ACTIONS::placeImportedGraphics.MakeEvent() );
}
