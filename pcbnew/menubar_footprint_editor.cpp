...
void FOOTPRINT_EDIT_FRAME::doReCreateMenuBar()
{
    ...
    submenuImport->Add( PCB_ACTIONS::analyseLCEDAFP, ACTION_MENU::NORMAL, _( "LCFP..." ) );
    submenuImport->Add( PCB_ACTIONS::multiAnalyseLCEDAFP, ACTION_MENU::NORMAL, _( "MultiLCFP..." ) );
