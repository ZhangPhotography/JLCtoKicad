...
TOOL_ACTION PCB_ACTIONS::analyseLCEDAFP( "pcbnew.ModuleEditor.analyseLCEDAFP", AS_GLOBAL, 0, "",
                                          _( "Import LCEDAFP..." ),
                                          _( "Import LCEDAFP from file" ),
                                          BITMAPS::import_module );
TOOL_ACTION PCB_ACTIONS::multiAnalyseLCEDAFP( "pcbnew.ModuleEditor.multiAnalyseLCEDAFP", AS_GLOBAL, 0,
                                              "",
                                         _( "Multi Import LCEDAFP..." ), _( "Import LCEDAFP from file" ),
                                         BITMAPS::import_module );
